...
function Card({data,reference}) {
  return (
    <motion.div drag dragConstraints={reference} className='relative w-60 flex-shrink-0 h-72 rounded-[45px] bg-zinc-900/90 text-white px-8 py-10 overflow-hidden m-3'>
        <FaRegFileAlt />
